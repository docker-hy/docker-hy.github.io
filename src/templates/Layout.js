                  ...
                  meta={[
                    {
                      name: "description",
                      content:
                        "Free MOOC from the University of Helsinki. The course focuses on container technology and practices around containerization.",
                    },
                    {
                      name: "keywords",
                      content:
                        "ohjelmointi, programming, MOOC, 2022, avoin, ilmainen, helsingin yliopisto",
                    },
                  ]}
                />
                <Sidebar
